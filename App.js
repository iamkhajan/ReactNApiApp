...
const postUser=() => {
  axios({
    method: 'post',
    url: 'https://url-shortener-nu.herokuapp.com/api/alias',
    data:{
      url: "https://medium.com/huawei-developers/android-clean-app-base-library-clean-architecture-mvvm-part-i-e8614978877f"
    }
  })
